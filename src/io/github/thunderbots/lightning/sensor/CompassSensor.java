...
public class CompassSensor extends com.qualcomm.robotcore.hardware.CompassSensor implements Sensor {
	...
	public CompassSensor(com.qualcomm.robotcore.hardware.CompassSensor baseSensor) {
		this.baseSensor = baseSensor;
	}

	@Override
	public Object getReadValue() {
		return this.baseSensor.getDirection();
	}
	...
	public boolean calibrationFailed() {
		return this.baseSensor.calibrationFailed();
	}
